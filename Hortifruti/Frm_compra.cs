...
namespace Hortifruti
{
    public partial class Frm_compra : Form
    {
        ...
        private void Frm_compra_Load(object sender, EventArgs e)
        {
            ...
            this.compraTableAdapter.Fill(this.hortifruti_dbDataSet7.Compra);
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (confirm.ToString().ToUpper() == "YES")
            {
                ...
                string dado;
                //int colunaAtual = dgvCompra.CurrentCell.ColumnIndex; -- A coluna do pagamento é a 8!
                ...
                try
                {
                    ...
                    comando.Parameters.AddWithValue("@produtor", dgvCompra.Rows[linhaAtual].Cells[2].Value.ToString());
                    comando.Parameters.AddWithValue("@produto", dgvCompra.Rows[linhaAtual].Cells[3].Value.ToString());
                    comando.Parameters.AddWithValue("@data", dgvCompra.Rows[linhaAtual].Cells[0].Value.ToString());
                    comando.Parameters.AddWithValue("@preco", dgvCompra.Rows[linhaAtual].Cells[7].Value);
                    ...
                    if (dr.Read())
                    {
                        ...
                        //MessageBox.Show("Pegou o id da Compra, ele é = " + aux1);
