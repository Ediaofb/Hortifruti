...
namespace Hortifruti
{
    public partial class Frm_fornecedor : Form
    {
        ...
        {
            // TODO: esta linha de código carrega dados na tabela 'hortifruti_dbDataSet7.Produtor'. Você pode movê-la ou removê-la conforme necessário.
            this.produtorTableAdapter.Fill(this.hortifruti_dbDataSet7.Produtor);
        }
